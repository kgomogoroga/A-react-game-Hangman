    ...
    return ( 
        <div className='help-container'>
            ...
            <ul>
                ...
                <li className='rules-list-item'>If you get the word correct, you will be awarded 10 pts and you will be moved on to the next word.</li>
                <li className='rules-list-item'>If at any point you get stuck you can select the "Hint" button to get a single correct letter given to you. However this will dock your points total by 2pts.</li>
